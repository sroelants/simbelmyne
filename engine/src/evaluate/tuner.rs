...
pub struct EvalWeights {
    ...
    pub knight_queen_threat: S,
    pub bishop_queen_threat: S,
    pub rook_queen_threat: S,
}
...
pub struct EvalTrace {
    ...
    pub knight_queen_threat: i32,
    pub bishop_queen_threat: i32,
    pub rook_queen_threat: i32,
}
