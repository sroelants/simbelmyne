...
pub fn print_eval(board: &Board) -> String {
  ...
  for (rank, squares) in Square::RANKS.into_iter().enumerate() {
    ...
    for (file, sq) in squares.into_iter().enumerate() {
      ...
      let score = if let Some(piece) = board.get_at(sq) {
        // Get score for piece
        let score = eval.material(piece, &mut NullTracer)
          + eval.psqt(piece, sq, &mut NullTracer);
  ...
  lines.push(format!(
    "{:<25} {:>7.2} {:>7.2}",
    "Pawn structure:", white_kp_structure, black_kp_structure
  ));
  ...
  lines.push(format!(
    "{:<25} {:>7.2} {:>7.2}",
    "Bishop pair", white_bishop_pair, black_bishop_pair
  ));
  ...
  lines.push(format!(
    "{:<25} {:>7.2} {:>7.2}",
    "Rook on open file:", white_rook_open_file, black_rook_open_file
  ));
  ...
  lines.push(format!(
    ...
    white_rook_semiopen_file,
    black_rook_semiopen_file
  ));
  ...
  lines.push(format!(
    "{:<25} {:>7.2} {:>7.2}",
    "Connected rooks:", white_connected_rooks, black_connected_rooks
  ));
  ...
  lines.push(format!(
    "{:<25} {:>7.2} {:>7.2}",
    "Queen on open file:", white_queen_open_file, black_queen_open_file
  ));
  ...
  lines.push(format!(
    "{:<25} {:>7.2} {:>7.2}",
    "Queen on semiopen file:",
    white_queen_semiopen_file,
    black_queen_semiopen_file
  ));
  ...
  lines.push(format!(
    "{:<25} {:>7.2} {:>7.2}",
    "Major on 7th:", white_major_on_7th, black_major_on_7th
  ));
  ...
  lines.push(format!(
    "{:<25} {:>7.2} {:>7.2}",
    "Virtual mobility:", white_virtual_mobility, black_virtual_mobility
  ));
  ...
  lines.push(format!(
    "{:<25} {:>7.2} {:>7.2}",
    "King zone:", white_king_zone, black_king_zone
  ));
