...
use super::lookups::{gen_bishop_attacks, gen_rook_attacks, rook_mask, bishop_mask};
...
pub const fn gen_entries<const BISHOP: bool>() -> [PextEntry; Square::COUNT] {
    let mut offset = 0;
    let mut entries: [PextEntry; Square::COUNT] = [
        PextEntry { mask: Bitboard::EMPTY, offset: 0 }; 
        Square::COUNT
    ];
