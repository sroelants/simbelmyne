...
pub struct History {
    ...
    pub pawn_corrhist: Box<CorrHistTable>,
    pub nonpawn_corrhist: Box<CorrHistTable>,
    pub material_corrhist: Box<CorrHistTable>,
    pub minor_corrhist: Box<CorrHistTable>,
...
impl History {
    pub fn new() -> Self {
        Self {
            ...
            pawn_corrhist: CorrHistTable::boxed(),
            nonpawn_corrhist: CorrHistTable::boxed(),
            material_corrhist: CorrHistTable::boxed(),
            minor_corrhist: CorrHistTable::boxed(),
